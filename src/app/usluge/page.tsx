...
export const metadata: Metadata = {
  title: 'Usluge | Gipsarski i Molerski Radovi — SG Gipsarko Subotica',
  description:
...
export default function Usluge() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative min-h-[280px] h-[50vh] max-h-[400px] flex items-center justify-center bg-dark-primary overflow-hidden mt-14 md:mt-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-dark-primary/90 via-dark-primary/60 to-transparent" />
        <div className="relative z-10 text-center text-white max-w-container-max px-4 md:px-gutter">
          <span className="font-label text-label text-gold-primary uppercase mb-4 block tracking-[0.15em]">Naša stručnost</span>
          <h1 className="font-headline-xl text-headline-xl-mobile md:text-headline-xl mb-6">
            Profesionalne usluge za Vaš enterijer
          </h1>
          <p className="font-body-lg text-body-lg max-w-2xl mx-auto text-text-light">
      ...
      <SectionContainer className="space-y-32 bg-dark-primary">
        {/* Service 1: Gipsarski radovi */}
        <div className="flex flex-col md:flex-row gap-gutter items-center">
          <div className="w-full md:w-1/2">
            <img
              className="w-full aspect-[4/3] object-cover border border-outline-variant shadow-lg"
          ...
          <div className="w-full md:w-1/2 space-y-6">
            <div className="flex items-center gap-2">
              <Construction className="w-6 h-6 text-gold-primary" />
              <h2 className="font-headline-lg text-headline-lg text-white">Gipsarski radovi</h2>
            </div>
            ...
            <div className="bg-dark-graphite p-6 border-l-4 border-gold-primary">
              <ul className="space-y-4">
                <li className="flex gap-3">
                  ...
                  <span className="font-body-md text-text-light">Izrada spuštenih plafona svih nivoa</span>
                </li>
                <li className="flex gap-3">
                  <CheckCircle2 className="w-5 h-5 text-gold-primary flex-shrink-0" />
                  <span className="font-body-md text-text-light">Oblaganje zidova (suvo malterisanje)</span>
                </li>
                <li className="flex gap-3">
                  <CheckCircle2 className="w-5 h-5 text-gold-primary flex-shrink-0" />
                  <span className="font-body-md text-text-light">Sve vrste gipsarskih elemenata</span>
                </li>
              </ul>
            </div>
            <div className="flex gap-4 items-center">
              <span className="font-label text-label bg-dark-surface text-gold-primary px-3 py-1 border border-gold-primary/30">MATERIJAL: KNAUF / RIGIPS</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row-reverse gap-gutter items-center">
          ...
          <div className="w-full md:w-1/2 space-y-6">
            <div className="flex items-center gap-2">
              <Building className="w-6 h-6 text-gold-primary" />
              <h2 className="font-headline-lg text-headline-lg text-white">Rigips konstrukcije</h2>
            </div>
            <p className="font-body-lg text-body-lg text-text-light">
            ...
            <div className="bg-dark-graphite p-6 border-l-4 border-gold-primary">
              <ul className="space-y-4">
                <li className="flex gap-3">
                  <CheckCircle2 className="w-5 h-5 text-gold-primary flex-shrink-0" />
                  <span className="font-body-md text-text-light">Pregradni zidovi sa termo i zvučnom izolacijom</span>
                </li>
                <li className="flex gap-3">
                  <CheckCircle2 className="w-5 h-5 text-gold-primary flex-shrink-0" />
                  <span className="font-body-md text-text-light">Skrivači svetla i kaskadni plafoni</span>
                </li>
                <li className="flex gap-3">
                  <CheckCircle2 className="w-5 h-5 text-gold-primary flex-shrink-0" />
                  <span className="font-body-md text-text-light">Izrada lukova i specifičnih formi</span>
                </li>
              </ul>
            </div>
            <div className="flex gap-4 items-center">
              <span className="font-label text-label bg-dark-surface text-gold-primary px-3 py-1 border border-gold-primary/30">PROFILI: POCINKOVANI ČELIK</span>
            </div>
          </div>
        </div>
          ...
          <div className="w-full md:w-1/2 space-y-6">
            ...
            <div className="bg-dark-graphite p-6 border-l-4 border-gold-primary">
              <ul className="space-y-4">
                <li className="flex gap-3">
                  <CheckCircle2 className="w-5 h-5 text-gold-primary flex-shrink-0" />
                  <span className="font-body-md text-text-light">Fino gletovanje i priprema za krečenje</span>
                </li>
                <li className="flex gap-3">
                  <CheckCircle2 className="w-5 h-5 text-gold-primary flex-shrink-0" />
            ...
            <div className="flex gap-4 items-center">
              <span className="font-label text-label bg-dark-surface text-gold-primary px-3 py-1 border border-gold-primary/30">BOJE: JUB / CAPAROL</span>
            </div>
          </div>
        </div>
      </SectionContainer>
      ...
      <SectionContainer className="bg-dark-primary">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="font-headline-lg text-headline-lg text-white mb-6">Područje rada</h2>
          <p className="font-body-lg text-body-lg text-text-light mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-dark-surface p-4 border border-outline-variant text-center hover:border-gold-primary/50 transition-colors">
              <span className="font-headline-md text-headline-md text-gold-primary">Subotica</span>
            </div>
            <div className="bg-dark-surface p-4 border border-outline-variant text-center hover:border-gold-primary/50 transition-colors">
              <span className="font-headline-md text-headline-md text-gold-primary">Palić</span>
            </div>
            <div className="bg-dark-surface p-4 border border-outline-variant text-center hover:border-gold-primary/50 transition-colors">
              <span className="font-headline-md text-headline-md text-gold-primary">Bački Vinogradi</span>
            </div>
            <div className="bg-dark-surface p-4 border border-outline-variant text-center hover:border-gold-primary/50 transition-colors">
              <span className="font-headline-md text-headline-md text-gold-primary">Okolina</span>
            </div>
          </div>
        </div>
      </SectionContainer>
